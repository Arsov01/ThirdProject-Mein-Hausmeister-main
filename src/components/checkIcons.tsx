...
function FeaturesSection() {
  const services = [
    { name: "Ѕидно сликање", image: Group1 },
    { name: "A / C  ", image: Group2 },
    { name: "Плочка потполнување", image: Group3 },
    { name: "Фасадно сликање", image: Group4 },
    { name: "Монтажа и поправка на прозорци", image: Group5 },
    { name: "Молери и лакови", image: Group6 },
    { name: "Плочка – Поплочување за ѕидови и подови ", image: Group7 },
    { name: "Електричар", image: Group8 },
    { name: "Цигла – ѕидање, малтерисување", image: Group9 },
    {
      name: "Бравар / Метал - Безбедносни врати,",
      image: Group10,
    },
    { name: "Фасадно сликање", image: Group11 },
